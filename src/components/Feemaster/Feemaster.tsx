...
const Feemaster = () => {
    ...
    console.log(checkboxHostel, "kkk");
    console.log(checkboxTrans, "transport");
    const handleClose = () => {
        setShow(false);
    ...
    console.log(checkboxOptional, "ss");
                                                        ...
                                                        <div style={{ marginBottom: "20px" }}>
                                                            <Row>
                                                                ...
                                                                <Col sm="4" style={{ marginTop: "20px" }}>
                                                                    <Form.Label style={{ marginLeft: "40px" }}>Enable For Optional</Form.Label>
                                                                </Col>
                                                                ...
                                                                {checkboxOptional ? (
                                                                    <>
                                                                        <Col sm="4" style={{ marginTop: "20px" }}>
                                                                            <Form.Label style={{ marginLeft: "40px" }}>All Students</Form.Label>
                                                                        </Col>
                                                                        <Col sm="6" style={{ marginLeft: "20px", marginTop: "20px" }}>
                                                                            <div>
                                                                                <input
                                                                        ...
                                                                        <Col sm="4" style={{ marginTop: "20px" }}>
                                                                            <Form.Label style={{ marginLeft: "40px" }}>Hostel Students</Form.Label>
                                                                        </Col>
                                                                        <Col sm="6" style={{ marginLeft: "20px", marginTop: "20px" }}>
                                                                            <div>
                                                                                <input
                                                                        ...
                                                                        <Col sm="4" style={{ marginTop: "20px" }}>
                                                                            <Form.Label style={{ marginLeft: "40px" }}>Transport Students</Form.Label>
                                                                        </Col>
                                                                        <Col sm="6" style={{ marginLeft: "20px", marginTop: "20px" }}>
                                                                            <div>
                                                                                <input
