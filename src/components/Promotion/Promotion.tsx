...
const Promotion = () => {
    ...
    //      .then((res) => {
    //          console.log("Getting from autoSearch::::", res.data.data);
    ...
    useEffect(() => {
        ...
        if (getStudentDetails && getStudentDetails.length > 0) {
            ...
            // else if(AllRoundData && AllRoundData.length > 0){
            //  setSpinnerLoad(true);
            // }
    ...
    const GotName = () => {
        allGotFinalData &&
            ...
            allGotFinalData.map((data: any) => {
                // console.log(data.student_id,"kkkkkkkkk");
            });
    };
    // useEffect(() => {
    //  Section();
                                                                    ...
                                                                    <Form.Select
                                                                        ...
                                                                        {getGradeSection &&
                                                                            ...
                                                                            getGradeSection.map((section: any) => {
                                                                                // console.log(getGradeSection   );
                                                                                // console.log(section.grade_id === eventGradeByYear?"1":"2");
                                                                                return (
                                                                                    <>
                                                                                        {" "}
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <Form.Select
                                                                                        ...
                                                                                        style={{ width: "150px" }}
                                                                                        onChange={(e: any) => {
                                                                                            setEventAcademicYearUpdate(e.target.value);
                                                                                            // setEventAcademicYearValue(e.target[e.target.selectedIndex].text);
                                                                                            UpdatePromotion(getGradeSection, e.target.value);
                                                                                        }}>
                                                                                                ...
                                                                                                return (
                                                                                                    <>
                                                                                                        {grade.academic_year_id ===
                                                                                                            Number(eventAcademicYearValueUpdate) && (
                                                                                                            <option
