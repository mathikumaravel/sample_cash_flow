                                            ...
                                            <div className="card-body bg-transparent">
                                                <div className="row">
                                                    <div className="col-sm-4">
                                                        <p className="mb-2">
                                                            <strong className="pr-1">Father Name</strong>{" "}
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="row" style={{ marginTop: "5px" }}>
                                                    <div className="col-sm-4">
                                                        <p className="mb-2">
                                                            <strong className="pr-1">Phone No</strong>{" "}
                                                        </p>
                                                    </div>
                                                    <div className="col-md-6 text-black" id="stud_phno">
                                                        9876543212
                                                    </div>
                                                </div>
                                                <div className="row" style={{ marginTop: "5px" }}>
                                                    <div className="col-sm-4">
                                                        <p className="mb-2">
                                                            <strong className="pr-1">Alt. Phone No</strong>{" "}
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="row" style={{ marginTop: "5px" }}>
                                                    ...
                                                    <div className="col-md-6 text-black" id="stud_add">
                                                        dwqd
                                                    </div>
                                                </div>
                                                <div className="row" style={{ marginTop: "5px" }}>
                                                    ...
                                                    <div className="col-md-6 text-black" id="stud_email">
                                                        akila@gmail.com
                                                    </div>
                                                </div>
